...
SECRET_KEY = 'django-insecure-_)@(-q1p%=*@p4^sr840xvd9j@b0$7u^$t0s2ly+6hnmfffqv9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'futuras-cientistas-dfdb879aee4c.herokuapp.com',
    'localhost',
    '127.0.0.1',
]
...
# Diretório onde o Django colocará os arquivos ao rodar 'collectstatic'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Diretórios adicionais onde o Django buscará arquivos estáticos
STATICFILES_DIRS = [
...
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'  # Definir o backend SMTP
