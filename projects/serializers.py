...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    regioes_aceitas_obj = serializers.StringRelatedField(many=True, read_only=True, source='regioes_aceitas')
    estados_aceitos_obj = serializers.StringRelatedField(many=True, read_only=True, source='estados_aceitos')
    cidades_aceitas_obj = serializers.StringRelatedField(many=True, read_only=True, source='cidades_aceitas')
