...
urlpatterns = [
    ...
    path('api/alunas-distribuicao-regional/', ApiAlunasDistribuicaoRegional.as_view(), name='api_alunas_distribuicao_regional'),
    path('api/alunas-distribuicao-estadual/', ApiAlunasDistribuicaoEstadual.as_view(), name='api_alunas_distribuicao_estadual'),
    path('api/alunas-distribuicao-cidades/', ApiAlunasDistribuicaoCidades.as_view(), name='api_alunas_distribuicao_cidades'),
